                    ...
                    <div class="card w-100">
                        ...
                        <div class="product_button">
                            <div class="remove_button">
                                <form action="admin_delete_product.php" method="POST" onsubmit="return confirm('Are you sure you want to remove this product?');">
                                    <input type="hidden" name="product_id" value="<?php echo $row['product_id']; ?>">
                                    <button type="submit" name="remove">Remove</button>
                                </form>
                            </div>
                            <div class="add_sample_button">
                                <button id="add_sample_button" type="button" class="btn  col-sm-6 col-lg-3" data-bs-toggle="modal" data-bs-target="#addsample-<?php echo $row['product_id']; ?>">
                                    Add Samples
                                </button>

                                <!-- Modal -->
                                <div class="modal fade" id="addsample-<?php echo $row['product_id']; ?>" tabindex=" -1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="add-product ">
                                                    <form action="admin_adding_sample.php" method="POST" autocomplete="off" enctype="multipart/form-data">
                                                        <div class="mt-1 mb-1">
                                                            <input class="w-100 p-2" type="hidden" name="product_id" id="product_id" value="<?php echo $row['product_id']; ?>">
                                                        </div>
                                                        <div class="m-2">
                            ...
                            <div class="edit_button">
                                <button id="edit_button" type="button" class="btn  col-sm-6 col-lg-3" data-bs-toggle="modal" data-bs-target="#editproduct">
                                    Edit Product
                                </button>
                                                ...
                                                <div class="add-product ">
                                                    <form action="admin-add-producs.php" method="POST" autocomplete="off" enctype="multipart/form-data">
                                                        <div class="mt-1 mb-1">
                                                            ...
                                                            <input class="w-100 p-2" type="text" name="product_name" id="product_name" placeholder="Product name" required>
                                                        </div>
                                                        <div class="mt-1 mb-1">

                                                            <input class="w-100 p-2" type="number" name="price" id="price" placeholder="Product price" required>
                                                        </div>
                                                        <div class="mt-2 mb-1">
                                                            <h5>Product Image</h5>
                                                            <input type="file" name="image_file" accept=".jpg, .jpeg, .png">
                        ...
                        <div class="card-body">
                            ...
                            <a href="admin_product_preview.php?product_id=<?php echo $row['product_id']; ?>" class="btn btn-primary w-100">View
                                Product</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal fade" id="addproduct" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="add-product ">
                                <form action="admin_add_products.php" method="POST" autocomplete="off" enctype="multipart/form-data">
                                    <div class="mt-1 mb-1">
