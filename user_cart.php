        ...
        if (!empty($_SESSION['cart'])) : ?>
            ...
            <div id="select_all" class="container rounded p-2 mb-2 ps-2 d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <a href="user_check_out.php"><button id="check_out" class="py-3 p-2 rounded">Check Out (<?php echo count($_SESSION['cart']); ?>)</button></a>
                </div>
            </div>
                ...
                <div class="cart_item">
                    ...
                    <div class="edit_delete">
                        <div class="edit_button">
                            <a href="user_product_update.php?product_id=<?php echo $item['product_id']; ?>&index=<?php echo $index; ?>"><button>Edit</button></a>
                        </div>
