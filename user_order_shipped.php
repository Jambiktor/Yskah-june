...
<nav class="navbar navbar-expand-lg navbar-light bg-light m-0 p-0">
        ...
        <div id="container" class="container-fluid-sm container-md rounded mb-3 mt-3 p-3">
            ...
            <a class="order_nav_a " href="user_order.php" >For Confirmation</a>
                ...
                <a class="order_nav_a active" href="user_order_shipped.php" >Shipped</a>
            ...
            <div id="order_item" class="rounded mt-3 p-2">
                <div id="order_head" class="container w-100  mb-2 p-2 me-0">
                    ...
                    <p id="shipping_information_text" class="m-0 text-end">The order has been shipped.</p>
                </div>
                    ...
                    <div class="container d-flex align-items-center justify-content-end p-2 pt-3 pe-3">
                        <p class="m-0">Total: </p> <h5 id="price" class="ms-2 m-0">₱ 00.00</h5>
                    </div>
                </div>
            </a>     
