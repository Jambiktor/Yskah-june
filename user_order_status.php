...
<nav class="navbar navbar-expand-lg navbar-light bg-light m-0 p-0">
        ...
        <div id="shipping_information" class="container rounded d-flex justify-content-start align-items-start flex-column mt-3 p-3">
                ...
                <div class="w-100 d-flex align-items-center justify-content-between ">
                    <p id="payment_details_text" class=" m-0 ms-2">Order ID</p><p id="payment_details_text" class="m-0 me-2">000000</p>
                </div>
                <div class="w-100 d-flex align-items-center justify-content-between">
                    <p id="payment_details_text" class="m-0 ms-2 ">Order Time</p><p id="payment_details_text" class="m-0 me-2">mm/dd/yy</p>
                </div>
